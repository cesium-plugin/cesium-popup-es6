import { Cartesian2, Cartesian3, SceneTransforms, Math as CesiumMath, Cesium3DTileFeature, Cesium3DTileset, Model, Cartographic, EllipsoidTerrainProvider } from "cesium";
                ...
                if (!isNaN(Number(i))) {
                    ...
                    if (isOn3dtiles) {
                        ...
                        if (cartesian3) {
                            ...
                            const lon = CesiumMath.toDegrees(cartographic.longitude), lat = CesiumMath.toDegrees(cartographic.latitude), height = cartographic.height;
